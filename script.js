    ...
    shareBtn.onclick = async () => {
      try {
        ...
        if(navigator.canShare && navigator.canShare({files:[file]})){
          await navigator.share({files:[file], title:'A postcard for you ✦', text:'Made with love at postcard-beige.vercel.app'});
        } else {
          await navigator.share({title:'A postcard for you ✦', text:'Sent with love — make your own at https://postcard-beige.vercel.app', url:'https://postcard-beige.vercel.app'});
        }
      } catch(e){
